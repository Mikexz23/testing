(() => {
  ...
  function goBack(){if(backPending)return;if(modal){closeModal();return;}if(stack.length){backPending=true;history.back();return;}navigate({page:{holding:'deposits',transaction:'records',incomedetail:'income',records:'deposits',deposits:'overview',overview:'home',products:'deposits',login:'home',fxclosed:'forex'}[route.page]||'home'},{back:true,replace:true});}
